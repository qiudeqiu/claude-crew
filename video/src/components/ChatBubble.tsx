...
> = {
  you: { initial: "我", color: "#3390EC", nameColor: "" },
  leo: { initial: "李", color: "#3390EC", nameColor: "#3390EC" },
  momo: { initial: "墨", color: "#A45EFF", nameColor: "#A45EFF" },
  nova: { initial: "诺", color: "#FF4081", nameColor: "#FF4081" },
  kira: { initial: "琪", color: "#FF9100", nameColor: "#FF9100" },
  sage: { initial: "森", color: "#00D1A0", nameColor: "#00D1A0" },
  商城_bot: {
    initial: "🛒",
    color: "#00D1A0",
    nameColor: "#7A7A80",
