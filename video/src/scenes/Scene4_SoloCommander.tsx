...
const SCENE4_BUBBLES: Bubble[] = [
  ...
  {
    id: "s4-cmd1", time: 0.3, sender: "you", side: "right", type: "message",
    nameColor: "", bubbleColor: "#007AFF", textColor: "#FFFFFF",
    content: "@商城_bot 把支付超时从 30s 改成 60s，加个重试",
    font: "Inter", phase: "s4-cmd",
  },
  {
    id: "s4-cmd2", time: 1.1, sender: "you", side: "right", type: "message",
    nameColor: "", bubbleColor: "#007AFF", textColor: "#FFFFFF",
    content: "@官网_bot 首页 hero 区文案换成春季版",
    font: "Inter", phase: "s4-cmd",
  },
  {
    id: "s4-cmd3", time: 1.8, sender: "you", side: "right", type: "message",
    nameColor: "", bubbleColor: "#007AFF", textColor: "#FFFFFF",
    content: "@小程序_bot 暗黑模式适配一下新组件库",
    font: "Inter", phase: "s4-cmd",
  },
  {
    id: "s4-cmd4", time: 2.4, sender: "you", side: "right", type: "message",
    nameColor: "", bubbleColor: "#007AFF", textColor: "#FFFFFF",
  ...
  {
    id: "s4-p1", time: 3.2, sender: "商城_bot", side: "left", type: "progress",
    nameLabel: "商城_bot", nameColor: "#7A7A80",
    bubbleColor: "#E8EDF2", textColor: "#505055",
    content: "⚙️ working... (3s)\n → 🔧 Edit: payment.config.ts",
    font: "JetBrains Mono", phase: "s4-work",
  },
  {
    id: "s4-p2", time: 3.6, sender: "官网_bot", side: "left", type: "progress",
  ...
  {
    id: "s4-p3", time: 4.0, sender: "小程序_bot", side: "left", type: "progress",
  ...
  {
    id: "s4-p4", time: 4.3, sender: "活动_bot", side: "left", type: "progress",
  ...
  // ── 4 results ──
  {
    id: "s4-r1", time: 5.5, sender: "商城_bot", side: "left", type: "result",
    nameLabel: "商城_bot", nameColor: "#7A7A80",
    bubbleColor: "#F0F0F2", textColor: "#1C1C1E",
    content: "✅ 超时已改为 60s + 添加 3 次重试逻辑，单元测试通过",
    font: "Inter", phase: "s4-result",
  },
  {
    id: "s4-r2", time: 6.2, sender: "官网_bot", side: "left", type: "result",
    nameLabel: "官网_bot", nameColor: "#7A7A80",
    bubbleColor: "#F0F0F2", textColor: "#1C1C1E",
  ...
  {
    id: "s4-r3", time: 6.8, sender: "小程序_bot", side: "left", type: "result",
    nameLabel: "小程序_bot", nameColor: "#7A7A80",
    bubbleColor: "#F0F0F2", textColor: "#1C1C1E",
  ...
  {
    id: "s4-r4", time: 7.4, sender: "活动_bot", side: "left", type: "result",
    nameLabel: "活动_bot", nameColor: "#7A7A80",
    bubbleColor: "#F0F0F2", textColor: "#1C1C1E",
  ...
  // ── Mic drop ──
  {
    id: "s4-done", time: 8.5, sender: "you", side: "right", type: "message",
    nameColor: "", bubbleColor: "#007AFF", textColor: "#FFFFFF",
    content: "完美 👏",
    font: "Inter", phase: "s4-done",
  },
];
...
const SoloHeader: React.FC = () => {
  ...
  const opacity = interpolate(frame, [0, sec(0.3)], [0, 1], { extrapolateRight: "clamp" });
  return (
    <div style={{
      width: CONFIG.chat.width, height: CONFIG.chat.headerHeight,
      display: "flex", alignItems: "center", padding: "0 24px", gap: 16, opacity,
      ...
      <div style={{ display: "flex", flexDirection: "column" }}>
        <span style={{ fontFamily: fontFamilyInter, fontSize: 36, fontWeight: 700, color: "#1C1C1E" }}>
          我的 Bot 军团
        </span>
        <span style={{ fontFamily: fontFamilyInter, fontSize: 22, color: "#AEAEB2" }}>
...
export const Scene4_SoloCommander: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: CONFIG.background }}>
      {/* Project badge */}
      <ProjectBadge
        opacity={interpolate(frame, [0, sec(0.2), sec(2.0), sec(2.2)], [0, 1, 1, 0], {
          extrapolateLeft: "clamp", extrapolateRight: "clamp",
        })}
        textBlockHeight={260}
      />
