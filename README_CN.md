...
- **多项目、团队、要 @mention 集群管理** → **[claude-crew](https://github.com/qiudeqiu/claude-crew)** — 全员在同一个群里：@mention 并行派发任务，实时看到所有进度和结果，随时沟通讨论，即时对结果作出反应。团队权限、仪表盘、定时任务，全在 Telegram 内完成
